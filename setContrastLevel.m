...
function setContrastLevel(initSetting, experimentPars, cfsPars, idiomListShuffled, experimentFont)
	...
	DrawFormattedText(initSetting.windowPtr, c_text.instruction{10}, cfsPars.centerDomin(1) - experimentFont.textOffSet, cfsPars.centerNDomin(2) - experimentFont.textOffSet, 0, 40, [], [], 1.5, []); %[, sx][, sy][, color][, wrapat][, flipHorizontal][, flipVertical][, vSpacing][, righttoleft]
